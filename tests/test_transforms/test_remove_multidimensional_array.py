...
from transforms.remove_multidimensional_arrays import RemoveMultidimensionalArray
...
class TestRemoveMultiDimensionalArrays(GoldenTestCase):
    ...
    def setUp(self):
        """Set up test cases"""
        self.fixtures = '/test_transforms/fixtures/remove_multidimensional_arrays'
    ...
    def transform(self, ast):
        ...
        self.transformer = RemoveMultidimensionalArray(IDGenerator(ast), environments)
